...
#  Default: ''
c.NotebookApp.notebook_dir = 'C:/20220103_lab/14.python/'
...
#  password.
#  Default: ''
# c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$6ltpyD693HCweDVgjgbXPQ$MDI6iX5IsNjMsEHF+LuOsQ'
...
#  Choices: any of ['sha3_224', 'sha256', 'blake2s', 'blake2b', 'sha3_256', 'sha224', 'sha1', 'md5', 'sha384', 'sha512', 'sha3_512', 'sha3_384']
#  Default: 'sha256'
